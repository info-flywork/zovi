...
abstract final class Countries {
  static const List<Country> all = [
    ...
    Country(isoCode: 'BN', name: 'Brunei', dialCode: '+673'),
    ...
    Country(isoCode: 'CV', name: 'Cape Verde', dialCode: '+238'),
    ...
    Country(isoCode: 'CD', name: 'Congo (DRC)', dialCode: '+243'),
    ...
    Country(isoCode: 'MO', name: 'Macau', dialCode: '+853'),
    ...
    Country(isoCode: 'KP', name: 'North Korea', dialCode: '+850'),
    ...
    Country(isoCode: 'VC', name: 'Saint Vincent', dialCode: '+1'),
    Country(isoCode: 'WS', name: 'Samoa', dialCode: '+685'),
    Country(isoCode: 'SM', name: 'San Marino', dialCode: '+378'),
    Country(isoCode: 'ST', name: 'São Tomé and Príncipe', dialCode: '+239'),
  ...
  static Country? findByIso(String isoCode) {
    try {
